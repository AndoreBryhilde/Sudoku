...
const record_screen = document.querySelector('#record-screen');
// ----------
...
document.querySelector('#btn-record').addEventListener('click', () => {
    get_record();
    record_screen.classList.add('active');
    start_screen.classList.remove('active');
});
...
document.querySelector('#btn-Back').addEventListener('click', () => {
    ...
    start_screen.classList.add('active');
    record_screen.classList.remove('active');
});
...
document.querySelector('#result-save').addEventListener('click', () => {
    console.log(player_name.innerHTML,game_level.innerHTML,seconds);
    save(player_name.innerHTML, game_level.innerHTML, seconds);  
});
// -------------
